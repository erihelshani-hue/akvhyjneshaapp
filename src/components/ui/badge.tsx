...
const badgeVariants = cva(
  /* Base: pill shape, editorial micro-type — matches website chips (.event-tag, .valle-row strong) */
  "inline-flex items-center gap-1 rounded-full px-2.5 py-1 font-inter text-[0.65rem] font-bold uppercase tracking-[0.2em] transition-colors",
  {
    variants: {
      variant: {
